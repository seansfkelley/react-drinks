...
describe('filteredGroupedRecipes', function() {
  describe('#_baseLiquorFilter', function() {
    ...
    return it('should retain recipes if any "base" matches when it\'s an array of strings', () =>
      _.filter([
        RECIPE_A,
        RECIPE_A_B
  ...
  return describe('#_sortAndGroupAlphabetical', function() {
    ...
    return it('should sort the recipes in each group by their full "sortName" property', () =>
      _sortAndGroupAlphabetical([
